...
public class Rewriter implements JistAPI.CustomRewriter
{
  ...
  public JavaClass process(JavaClass jcl) throws ClassNotFoundException
  {
    ...
    jcl = (new runtime.ClassTraversal(new ModifyTypeTraversal(typeModifications))).processClass(jcl);
    return jcl;
  }
  ...
  {
    if(runtime.Rewriter.isIgnoredStatic(classname)) return true;
   ...
   * @since SWANS1.0
   */
  public static class ModifyTypeTraversal extends runtime.ClassTraversal.Empty
  {
